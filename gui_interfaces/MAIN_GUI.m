...
% Last Modified by GUIDE v2.5 27-Mar-2020 11:07:22
...
switch optype
    case 'util' %utility (added by TJ
        evalc(cat(2,'[ success, message ] = ',func,'(hDATA);'));  
    case 'data'
        % data processor
...
% --- Otherwise, executes on mouse press in 5 pixel border or over BUTTON_CALCULATE.
function BUTTON_CALCULATE_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to BUTTON_CALCULATE (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes when selected cell(s) is changed in TABLE_DATAINFO.
function TABLE_DATAINFO_CellSelectionCallback(hObject, eventdata, handles)
% hObject    handle to TABLE_DATAINFO (see GCBO)
...
% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over MENU_USEROP.
function MENU_USEROP_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to MENU_USEROP (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
